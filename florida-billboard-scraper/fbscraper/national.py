"""National seed dataset: billboard / OOH companies across 42 major US metros.
...
Seattle, Minneapolis, Phoenix, Tampa, Denver, Cleveland, Sacramento, Orlando,
St. Louis, Pittsburgh, San Diego, Baltimore, Charlotte, Raleigh, Indianapolis,
Cincinnati, Las Vegas, San Antonio, Portland, Milwaukee, Columbus, Kansas City,
Nashville, Salt Lake City, New Orleans, Oklahoma City, Memphis, Richmond, Austin,
Jacksonville.
...
# 42 major US OOH markets, listed in market-size rank order (see CITY_MARKET).
TOP_CITIES = [
    ...
    "Tampa", "Denver", "Cleveland", "Sacramento", "Orlando",
    "St. Louis", "Pittsburgh", "San Diego", "Baltimore", "Charlotte",
    "Raleigh", "Indianapolis", "Cincinnati", "Las Vegas", "San Antonio",
    "Portland", "Milwaukee", "Columbus", "Kansas City", "Nashville",
    "Salt Lake City", "New Orleans", "Oklahoma City", "Memphis", "Richmond",
    "Austin", "Jacksonville",
]
...
NATIONAL_SEED: List[Company] = [
    ...
    Company(
        ...
        counties_served="Houston; Dallas; San Antonio; Phoenix; Austin; Seattle; San Diego; Jacksonville; Detroit; Minneapolis; Charlotte; Tampa; Sacramento; Indianapolis; Columbus; Kansas City; St. Louis; Baltimore; Oklahoma City",
        serves_palm_beach="No",
    ...
    Company(
        ...
        company_type=TYPE_REGIONAL,
        primary_market="Mid-size US markets (13 states); Atlanta; Charlotte; Raleigh",
        counties_served="New York; Atlanta; Charlotte; Raleigh",
        serves_palm_beach="No",
        pricing_reference=_REF,
    ...
    Company(
        ...
        counties_served="Atlanta; Charlotte; Raleigh",
        serves_palm_beach="No",
        state="GA",
    ...
    Company(
        ...
        company_type=TYPE_MOBILE,
        primary_market="National mobile (largest digital-truck fleet; 200+ cities)",
        counties_served="All listed metros (nationwide)",
        serves_palm_beach="Yes",
    ...
    Company(
        ...
        counties_served="Charlotte; Nashville; Raleigh; Memphis",
        serves_palm_beach="No",
        state="NC",
    ...
    Company(
        ...
        counties_served="Columbus; Cincinnati; Cleveland",
        serves_palm_beach="No",
        city="Columbus",
        state="OH",
    ...
    Company(
        ...
        company_type=TYPE_REGIONAL,
        primary_market="Columbus; Cincinnati; Cleveland; Dayton; Toledo",
        counties_served="Columbus; Cincinnati; Cleveland",
        serves_palm_beach="No",
        state="OH",
    ...
    # ================================================================== #
    # OHIO / WISCONSIN (Cincinnati, Cleveland, Milwaukee)
    # ================================================================== #
    Company(
        company_name="Outdoor Advertising Center",
        company_type=TYPE_REGIONAL,
        primary_market="Ohio + Wisconsin (Columbus, Cleveland, Cincinnati, Milwaukee, Madison…)",
        counties_served="Cincinnati; Cleveland; Milwaukee; Columbus",
        serves_palm_beach="No",
        website="https://www.outdooradvertisingcenter.com/",
        pricing_reference=_REF,
        notes="Regional operator across Ohio (Columbus/Cleveland/Cincinnati/Toledo/Akron/Dayton) "
              "and Wisconsin (Milwaukee/Madison/Green Bay).",
        source="outdooradvertisingcenter.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),

    # ================================================================== #
    # LOUISIANA / OKLAHOMA (New Orleans, Oklahoma City)
    # ================================================================== #
    Company(
        company_name="Lindmark Outdoor Media",
        company_type=TYPE_REGIONAL,
        primary_market="AR / LA / NM / OK / TX (7,400+ faces, 515 cities)",
        counties_served="New Orleans; Oklahoma City",
        serves_palm_beach="No",
        pricing_reference=_REF,
        notes="One of the largest US OOH firms — 7,400+ static & digital faces across "
              "Arkansas, Louisiana, New Mexico, Oklahoma and Texas.",
        source="lindmarkbillboards.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
    Company(
        company_name="Headrick Outdoor Media",
        company_type=TYPE_REGIONAL,
        primary_market="Oklahoma + 7 states (independent)",
        counties_served="Oklahoma City",
        serves_palm_beach="No",
        state="OK",
        website="https://www.headrickoutdoormedia.com/",
        pricing_reference=_REF,
        notes="One of the largest independent OOH, manufacturing & installation firms — operates in 7 states.",
        source="headrickoutdoormedia.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
...
CITY_MARKET = [
    ...
    (18, "Cleveland", "OH", "Tier 3", 1000, 11000,
     "Cleveland/Akron/Canton; I-90 / I-77 / I-480 corridors; deep Ohio vendor stack."),
    (19, "Sacramento", "CA", "Tier 3 — CA capital", 1200, 11000,
     "Sacramento/Stockton/Modesto DMA; Clear Channel runs 1,280+ displays across 5 counties."),
    (20, "Orlando", "FL", "Tier 3 — tourism", 1200, 12000,
     "I-4 / theme-park & tourist corridors carry premiums; strong visitor reach."),
    (21, "St. Louis", "MO", "Tier 3 — bi-state metro", 1000, 10000,
     "Bi-state (MO/IL); DDI Media the dominant independent along I-70 and the Illinois side."),
    (22, "Pittsburgh", "PA", "Tier 3", 1000, 9000,
     "Parkway/tunnel approaches; strong independent scene (TM, Penneco, Steel City)."),
    (23, "San Diego", "CA", "Tier 3", 1500, 10000,
     "I-5 / I-805 / I-15 / Hwy-78 corridors; limited inventory keeps rates firm."),
    (24, "Baltimore", "MD", "Tier 3", 1200, 11000,
     "I-95 / I-695 Beltway; Vision Outdoor is the Mid-Atlantic's independent digital operator."),
    (25, "Charlotte", "NC", "Tier 3", 1000, 9000,
     "I-77 / I-85 / I-485 corridors; Adams Outdoor reaches 1.8M across 22 counties."),
    (26, "Raleigh", "NC", "Tier 3 — fast-growing", 1000, 10000,
     "Research Triangle; I-40 / I-440 Beltline; Adams/Allison/Trailhead active regionally."),
    (27, "Indianapolis", "IN", "Tier 3 — crossroads", 1000, 10000,
     "'Crossroads of America' — I-65/I-70/I-465; Lamar-dominant plus Keyes & Reagan."),
    (28, "Cincinnati", "OH", "Tier 3", 1000, 10000,
     "I-71 / I-75 / I-275 loop; tri-state (OH/KY/IN); Lamar & Key-Ads strong."),
    (29, "Las Vegas", "NV", "Tier 3 — Strip premium", 1500, 25000,
     "The Strip commands outsized rates (spectaculars far higher); OUTFRONT reaches 99.9% weekly."),
    (30, "San Antonio", "TX", "Tier 3", 1000, 8000,
     "I-10 / Loop 410 / US-281 the strongest placements."),
    (31, "Portland", "OR", "Tier 3", 1200, 11000,
     "Lamar is the largest footprint + sole PDX operator; wallscapes in the Pearl/Downtown."),
    (32, "Milwaukee", "WI", "Tier 3", 1000, 10000,
     "I-94 / I-43 corridors; Lamar-dominant plus regional Ohio/Wisconsin operators."),
    (33, "Columbus", "OH", "Tier 3 — deep vendor stack", 1000, 9000,
     "~2,200 boards; one of the Midwest's deepest OOH inventories (OAA of Ohio HQ'd here)."),
    (34, "Kansas City", "MO", "Tier 3 — bi-state", 1000, 9000,
     "I-35/I-70; Ad-Trend the largest locally owned operator (since 1985)."),
    (35, "Nashville", "TN", "Tier 3 — fast-growing", 1200, 11000,
     "I-40 / I-24 / I-65 and Broadway/tourism demand; Allison Outdoor active regionally."),
    (36, "Salt Lake City", "UT", "Tier 3 — constrained supply", 1000, 9000,
     "I-15 corridor; Reagan Outdoor (HQ) & YESCO dominate; billboards politically restricted."),
    (37, "New Orleans", "LA", "Tier 3 — tourism", 1000, 11000,
     "I-10 / French Quarter & tourism demand; Lamar (Louisiana roots) & Lindmark strong."),
    (38, "Oklahoma City", "OK", "Tier 3", 900, 8000,
     "I-35 / I-40 / I-44; Lindmark, Headrick and BM cover Oklahoma broadly."),
    (39, "Memphis", "TN", "Tier 3 — logistics hub", 900, 8000,
     "I-40 / I-55 freight corridors; Lamar-dominant plus Allison Outdoor regionally."),
    (40, "Richmond", "VA", "Tier 3", 900, 8000,
     "I-95 / I-64 corridors; Lamar & OUTFRONT dominant in a supply-limited market."),
    (41, "Austin", "TX", "Tier 3 — fast-growing", 1200, 12000,
     "Reagan Outdoor-dominated; tech-driven demand along I-35 / MoPac / US-183."),
    (42, "Jacksonville", "FL", "Tier 3", 800, 6000,
