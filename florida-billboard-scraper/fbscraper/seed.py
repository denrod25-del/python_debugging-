...
SEED: List[Company] = [
    ...
    Company(
        ...
        pricing_reference=_PB_REF,
        notes="Geo-targets Palm Beach/Broward/Miami-Dade incl. Boca Raton, Delray, "
              "Palm Beach; I-95, I-595, Turnpike, US-1 inventory.",
        source="hangingpantsmedia.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
    Company(
        company_name="Mobile Billboard Miami",
        company_type=TYPE_MOBILE,
        primary_market="Miami; Broward; Palm Beach",
        counties_served="Miami-Dade; Broward; Palm Beach",
        serves_palm_beach="Yes",
        address="6011 Rodman St, Unit 102",
        city="Hollywood",
        zip_code="33023",
        website="https://www.mobilebillboardmiami.com/",
        pricing_reference="Mobile LED truck — day/route rate, quote only",
        notes="13+ yrs; digital LED billboard trucks, event marketing, live streaming.",
        source="mobilebillboardmiami.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
    Company(
        ...
        pricing_reference=_PB_REF,
        notes="Boutique independent; static + digital on Palmetto (SR 826), Dolphin "
              "(SR 836) & Florida's Turnpike. FL Certified Minority Business; on "
              "Miami-Dade Asset Marketing Pool.",
        source="sde-media.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
    Company(
        company_name="Blip Billboards",
        company_type=TYPE_BROKER,
        primary_market="Statewide FL (self-serve digital)",
        counties_served="Statewide",
        serves_palm_beach="Yes",
        website="https://www.blipbillboards.com/billboard-locations/florida/",
        pricing_reference="Self-serve digital; pay-per-play, any budget — dynamic pricing",
        notes="Self-serve digital billboard marketplace; no minimum contract.",
        source="blipbillboards.com; WebSearch 2026-07-08",
        confidence="Medium",
    ),
    Company(
        company_name="Idon Media, LLC",
        company_type=TYPE_BROKER,
        primary_market="Florida (independent-operator network)",
        counties_served="Statewide",
        serves_palm_beach="Unknown",
        website="http://www.idonmedia.com/about-us",
        pricing_reference="Quote only",
        notes="FL subsidiary of Digital Outdoor Advertising, LLC; represents "
              "independent billboard operators for national reach.",
        source="idonmedia.com; WebSearch 2026-07-08",
        confidence="Low",
    ),
    ...
    Company(
        company_name="Bill Salter Outdoor Advertising",
        company_type=TYPE_REGIONAL,
        primary_market="Northwest Florida Panhandle",
        counties_served="Escambia; Santa Rosa; Okaloosa (NW FL)",
        serves_palm_beach="No",
        city="Milton",
        pricing_reference="Quote only",
        notes="Long-standing regional independent operator in the western Panhandle.",
        source="WebSearch 2026-07-08",
        confidence="Low",
    ),
    ...
    Company(
        ...
        company_type=TYPE_NATIONAL,
        primary_market="National transit / place-based (FL metros)",
        counties_served="Statewide FL (transit & place-based)",
        serves_palm_beach="Unknown",
        website="https://www.intersection.com/",
        pricing_reference="Quote only",
        notes="National OOH vendor; transit and place-based media, active in FL markets.",
        source="WebSearch 2026-07-08",
        confidence="Low",
    ),
    Company(
        company_name="View Outdoor",
        company_type=TYPE_NATIONAL,
        primary_market="Florida (OOH vendor)",
        counties_served="Statewide FL",
        serves_palm_beach="Unknown",
        pricing_reference="Quote only",
        notes="Named among major OOH vendors operating in Florida.",
        source="WebSearch 2026-07-08",
        confidence="Low",
    ),
]
